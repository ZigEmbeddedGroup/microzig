...
test "move" {
    ...
    const sent = [_][]const u8{
        ...
        &.{ 0x05, 0x00, 0xa2, 0x00, 0x00, 0x11, 0x7b, 0x04 },
        &.{ 0x05, 0x00, 0xa2, 0x00, 0x00, 0x22, 0xf7, 0x82 },
        &.{ 0x05, 0x00, 0xa2, 0x00, 0x00, 0x34, 0x72, 0xb1 },
        &.{ 0x05, 0x00, 0xa2, 0x00, 0x00, 0x45, 0xee, 0x7e },
        &.{ 0x05, 0x00, 0xa2, 0x00, 0x00, 0x57, 0x69, 0x24 },
    };
    try td.expect_sent(&sent);
}
