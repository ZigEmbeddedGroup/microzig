...
pub fn ST7735(display_cfg: DisplayConfig) type {
    return ST77xx_Generic(.{
        .device = .st7735,
    }, display_cfg);
}

pub fn ST7789(display_cfg: DisplayConfig) type {
    return ST77xx_Generic(.{
        .device = .st7789,
    }, display_cfg);
}
...
pub fn ST77xx_Generic(driver_cfg: DriverConfig, display_cfg: DisplayConfig) type {
    return struct {
        const Self = @This();
        const DatagramDevice = driver_cfg.DatagramDevice;
