...
pub const MLX90640 = struct {
    ...
    fn extract_deviating_pixels(self: *Self) Error!void {
        var pixCnt: u32 = 0;
        for (0..5) |i| {
            pixCnt = @intCast(i);
        ...
        if (brokenPixCnt > 4) {
            return error.TooManyBrokenPixels;
        } else if (outlierPixCnt > 4) {
            return error.TooManyOutlierPixels;
        } else if ((brokenPixCnt + outlierPixCnt) > 4) {
            return error.TooManyOutlierAndBrokenPixels;
        } else {
    ...
    fn check_adjacent_pixels(_: *Self, pix1: u16, pix2: u16) Error!void {
        var pixPosDif: i32 = 0;
...
test "control_register_values" {
    ...
    const TestClock = mdf.base.ClockDevice.TestDevice;
