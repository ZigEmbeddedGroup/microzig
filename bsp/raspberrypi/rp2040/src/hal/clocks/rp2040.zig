...
const lposc_freq = common.lposc_freq;
...
pub const Generator =
    ...
    const Impl = common.GeneratorImpl(Generator, Source);
...
pub const config = struct {
    pub const Global = struct {
        pub const GeneratorConfig = common.GeneratorConfig(Source);
    ...
    pub const preset = struct {
        ...
        pub fn system(sys_freq: u32, ref_freq: u32) Global {
            ...
            cfg.ref = .{
                ...
                .integer_divisor = calculate_integer_divisor(xosc_freq, ref_freq),
            };
            ...
            cfg.sys = .{
                ...
                .integer_divisor = calculate_integer_divisor(125_000_000, sys_freq),
            };
        ...
        pub fn output_to_gpio(gpio_outputs: GpioOutputs, comptime current_config: Global) Global {
            var cfg: Global = .{
                // Definitely need CLK_SYS for the frequency
                .sys = current_config.sys.?,
            };
...
/// NOTE: untested
pub fn count_frequency_khz(source: Source, comptime clock_cfg: config.Global) u32 {
    const ref_freq = clock_cfg.ref.?.frequency();
