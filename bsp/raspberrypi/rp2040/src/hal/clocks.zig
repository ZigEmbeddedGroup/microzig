...
const get_cpu = @import("compat.zig").get_cpu;

// Re-export of platform rectified clocks implementation
const chip_specific = switch (get_cpu()) {
    .RP2040 => @import("clocks/rp2040.zig"),
    .RP2350 => @compileError("TODO: RP2350 not supported yet!"),
};
...
/// NOTE: This API is completely untested
pub const count_frequency_khz = chip_specific.count_frequency_khz;
