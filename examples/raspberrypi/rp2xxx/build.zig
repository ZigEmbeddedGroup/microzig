...
pub fn build(b: *Build) void {
    ...
    const rp2040_only_examples: []const Example = &.{
        ...
        .{ .target = mz.ports.rp2xxx.boards.raspberrypi.pico, .name = "pico_uart-echo", .file = "src/rp2040_only/uart_echo.zig" },
        .{ .target = mz.ports.rp2xxx.boards.raspberrypi.pico, .name = "pico_uart-log", .file = "src/rp2040_only/uart_log.zig" },
