// SoftDevice S140 — peripheral + central + observer + extended advertising.
// Full-featured BLE stack for nRF52840, nRF52833, nRF52820.

pub const variant = @import("variant.zig").Variant.s140;
pub const gap = @import("gap.zig").Api(.s140);
