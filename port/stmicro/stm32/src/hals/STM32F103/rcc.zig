...
pub const Periferals = enums.Peripherals;
...
pub fn reset_clock(comptime peri: Periferals) void {
...
pub fn set_clock(comptime peri: Periferals, state: u1) void {
    const peri_name = @tagName(peri);
...
pub fn enable_clock(comptime peri: Periferals) void {
    set_clock(peri, 1);
}

pub fn disable_clock(comptime peri: Periferals) void {
    set_clock(peri, 0);
}
...
pub fn get_clock(comptime source: Periferals) u32 {
