...
pub fn enable_gpio_port(used_gpios_port: u8) void {
    RCC.AHBENR.modify(.{
        .GPIOAEN = 0b1 & used_gpios_port,
        .GPIOBEN = 0b1 & (used_gpios_port >> 1),
        .GPIOCEN = 0b1 & (used_gpios_port >> 2),
        .GPIODEN = 0b1 & (used_gpios_port >> 3),
        .GPIOEEN = 0b1 & (used_gpios_port >> 4),
        .GPIOFEN = 0b1 & (used_gpios_port >> 5),
        .GPIOGEN = 0b1 & (used_gpios_port >> 6),
        .GPIOHEN = 0b1 & (used_gpios_port >> 7),
    });
}
