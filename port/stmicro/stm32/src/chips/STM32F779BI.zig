...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "CAN2_TX", .index = 63, .description = null },
    .{ .name = "CAN2_RX0", .index = 64, .description = null },
    .{ .name = "CAN2_RX1", .index = 65, .description = null },
    .{ .name = "CAN2_SCE", .index = 66, .description = null },
    ...
    .{ .name = "DSI", .index = 98, .description = null },
    .{ .name = "SDMMC2", .index = 103, .description = null },
    .{ .name = "CAN3_TX", .index = 104, .description = null },
    .{ .name = "CAN3_RX0", .index = 105, .description = null },
    .{ .name = "CAN3_RX1", .index = 106, .description = null },
    .{ .name = "CAN3_SCE", .index = 107, .description = null },
    .{ .name = "JPEG", .index = 108, .description = null },
    .{ .name = "MDIOS", .index = 109, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    reserved113: [4]u32 = undefined,
    SDMMC2: Handler = unhandled,
    CAN3_TX: Handler = unhandled,
    CAN3_RX0: Handler = unhandled,
    CAN3_RX1: Handler = unhandled,
    CAN3_SCE: Handler = unhandled,
...
pub const peripherals = struct {
    ...
    pub const UID: *volatile types.peripherals.uid_v1.UID = @ptrFromInt(0x1ff0f420);
    /// VREFINT Factory Calibration
    pub const VREFINTCAL: *volatile types.peripherals.vrefintcal_v1.VREFINTCAL = @ptrFromInt(0x1ff0f44a);
    ...
    pub const CAN3: *volatile types.peripherals.can_bxcan.CAN = @ptrFromInt(0x40003400);
    ...
    /// Receiver Interface
    pub const SPDIFRX1: *volatile types.peripherals.spdifrx_v1.SPDIFRX = @ptrFromInt(0x40004000);
    ...
    /// Inter-integrated circuit
    pub const I2C4: *volatile types.peripherals.i2c_v2.I2C = @ptrFromInt(0x40006000);
    /// Controller area network
    pub const CAN1: *volatile types.peripherals.can_bxcan.CAN = @ptrFromInt(0x40006400);
    /// Controller area network
    pub const CAN2: *volatile types.peripherals.can_bxcan.CAN = @ptrFromInt(0x40006800);
    /// CEC.
    ...
    pub const SDMMC2: *volatile types.peripherals.sdmmc_v1.SDMMC = @ptrFromInt(0x40011c00);
    ...
    /// Serial peripheral interface
    pub const SPI5: *volatile types.peripherals.spi_v2.SPI = @ptrFromInt(0x40015000);
    /// Serial peripheral interface
    pub const SPI6: *volatile types.peripherals.spi_v2.SPI = @ptrFromInt(0x40015400);
    ...
    /// DSI Host.
    pub const DSIHOST: *volatile types.peripherals.dsihost_v1.DSIHOST = @ptrFromInt(0x40016c00);
    /// Management data input/output slave
    pub const MDIOS: *volatile types.peripherals.mdios_v1.MDIOS = @ptrFromInt(0x40017800);
    ...
    /// General-purpose I/Os
    pub const GPIOJ: *volatile types.peripherals.gpio_v2.GPIO = @ptrFromInt(0x40022400);
    /// General-purpose I/Os
    pub const GPIOK: *volatile types.peripherals.gpio_v2.GPIO = @ptrFromInt(0x40022800);
    ...
    /// Ethernet Peripheral
    pub const ETH: *volatile types.peripherals.eth_v1c.ETH = @ptrFromInt(0x40028000);
    /// DMA2D controller
    ...
    pub const DCMI: *volatile types.peripherals.dcmi_v1.DCMI = @ptrFromInt(0x50050000);
    /// JPEG codec
    pub const JPEG: *volatile types.peripherals.jpeg_v1.JPEG = @ptrFromInt(0x50051000);
    /// Cryptographic processor.
    pub const CRYP: *volatile types.peripherals.cryp_v2.CRYP = @ptrFromInt(0x50060000);
    /// Hash processor.
    pub const HASH: *volatile types.peripherals.hash_v2.HASH = @ptrFromInt(0x50060400);
