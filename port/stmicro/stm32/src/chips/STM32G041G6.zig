...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "DMA1_Ch4_5_DMAMUX1_OVR", .index = 11, .description = null },
    ...
    .{ .name = "LPTIM1", .index = 17, .description = null },
    .{ .name = "LPTIM2", .index = 18, .description = null },
...
pub const VectorTable = extern struct {
    ...
    DMA1_Ch4_5_DMAMUX1_OVR: Handler = unhandled,
