...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "SDMMC2", .index = 47, .description = null },
    ...
    .{ .name = "OCTOSPI1", .index = 71, .description = null },
    ...
    .{ .name = "OCTOSPI2", .index = 76, .description = null },
    ...
    .{ .name = "HASH_CRS", .index = 82, .description = null },
    .{ .name = "I2C4_ER", .index = 83, .description = null },
    .{ .name = "I2C4_EV", .index = 84, .description = null },
    .{ .name = "DCMI_PSSI", .index = 85, .description = null },
    .{ .name = "PKA", .index = 86, .description = null },
    .{ .name = "DMA2D", .index = 90, .description = null },
    .{ .name = "LTDC", .index = 91, .description = null },
    .{ .name = "LTDC_ER", .index = 92, .description = null },
    .{ .name = "DMAMUX1_OVR", .index = 94, .description = null },
};
...
pub const peripherals = struct {
    ...
    pub const SAI1: *volatile types.peripherals.sai_v1.SAI = @ptrFromInt(0x40015400);
    /// Serial audio interface
    pub const SAI2: *volatile types.peripherals.sai_v1.SAI = @ptrFromInt(0x40015800);
    /// DMA controller
    ...
    pub const RCC: *volatile types.peripherals.rcc_l4plus.RCC = @ptrFromInt(0x40021000);
    /// Flash
    ...
    /// General-purpose I/Os
    pub const GPIOI: *volatile types.peripherals.gpio_v2.GPIO = @ptrFromInt(0x48002000);
    /// USB on the go
    ...
    /// Analog-to-Digital Converter
    pub const ADC12_COMMON: *volatile types.peripherals.adccommon_v3.ADC_COMMON = @ptrFromInt(0x50040300);
    /// Digital camera interface
    pub const DCMI: *volatile types.peripherals.dcmi_v1.DCMI = @ptrFromInt(0x50050000);
    /// Parallel synchronous slave interface.
    pub const PSSI: *volatile types.peripherals.pssi_v1.PSSI = @ptrFromInt(0x50050400);
    /// Public key accelerator.
    pub const PKA: *volatile types.peripherals.pka_v1c.PKA = @ptrFromInt(0x5005e000);
    ...
    pub const RNG: *volatile types.peripherals.rng_v2.RNG = @ptrFromInt(0x50060800);
    /// OctoSPI IO Manager
    pub const OCTOSPIM: *volatile types.peripherals.octospim_v1.OCTOSPIM = @ptrFromInt(0x50061c00);
    /// OctoSPI
    pub const OCTOSPI1: *volatile types.peripherals.octospi_v1.OCTOSPI = @ptrFromInt(0xa0001000);
    /// OctoSPI
    pub const OCTOSPI2: *volatile types.peripherals.octospi_v1.OCTOSPI = @ptrFromInt(0xa0001400);
    /// MCU debug component
