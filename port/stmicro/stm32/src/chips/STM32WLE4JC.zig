...
pub const peripherals = struct {
    ...
    pub const SYSCFG: *volatile types.peripherals.syscfg_wle.SYSCFG = @ptrFromInt(0x40010000);
    ...
    pub const RCC: *volatile types.peripherals.rcc_wle.RCC = @ptrFromInt(0x58000000);
    /// Power control
    pub const PWR: *volatile types.peripherals.pwr_wl5.PWR = @ptrFromInt(0x58000400);
    /// External interrupt/event controller
    pub const EXTI: *volatile types.peripherals.exti_wle.EXTI = @ptrFromInt(0x58000800);
    /// Random number generator
    pub const RNG: *volatile types.peripherals.rng_v2.RNG = @ptrFromInt(0x58001000);
    /// Hardware semaphore.
    pub const HSEM: *volatile types.peripherals.hsem_v4.HSEM = @ptrFromInt(0x58001400);
