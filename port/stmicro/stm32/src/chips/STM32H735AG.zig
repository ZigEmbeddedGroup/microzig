...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "OTFDEC1", .index = 151, .description = null },
    .{ .name = "OTFDEC2", .index = 152, .description = null },
    .{ .name = "FMAC", .index = 153, .description = null },
    .{ .name = "CORDIC", .index = 154, .description = null },
    .{ .name = "UART9", .index = 155, .description = null },
    .{ .name = "USART10", .index = 156, .description = null },
    .{ .name = "I2C5_EV", .index = 157, .description = null },
    .{ .name = "I2C5_ER", .index = 158, .description = null },
    .{ .name = "FDCAN3_IT0", .index = 159, .description = null },
    .{ .name = "FDCAN3_IT1", .index = 160, .description = null },
    .{ .name = "TIM23", .index = 161, .description = null },
    .{ .name = "TIM24", .index = 162, .description = null },
};
...
pub const peripherals = struct {
    ...
    /// Inter-integrated circuit
    pub const I2C5: *volatile types.peripherals.i2c_v2.I2C = @ptrFromInt(0x40006400);
    /// CEC.
    ...
    /// Controller area network with flexible data rate (FD)
    pub const FDCAN3: *volatile types.peripherals.can_fdcan_h7.FDCAN = @ptrFromInt(0x4000d400);
    /// General purpose 32-bit timers
    pub const TIM23: *volatile types.peripherals.timer_v1.TIM_GP32 = @ptrFromInt(0x4000e000);
    /// General purpose 32-bit timers
    pub const TIM24: *volatile types.peripherals.timer_v1.TIM_GP32 = @ptrFromInt(0x4000e400);
    ...
    pub const FMAC: *volatile types.peripherals.fmac_v1.FMAC = @ptrFromInt(0x48024000);
    /// CORDIC co-processor.
    pub const CORDIC: *volatile types.peripherals.cordic_v1.CORDIC = @ptrFromInt(0x48024400);
    /// LCD-TFT Controller
    ...
    pub const OTFDEC1: *volatile types.peripherals.otfdec_v1.OTFDEC = @ptrFromInt(0x5200b800);
    /// On-The-Fly Decryption engine.
    pub const OTFDEC2: *volatile types.peripherals.otfdec_v1.OTFDEC = @ptrFromInt(0x5200bc00);
    ...
    /// Serial audio interface
    pub const SAI4: *volatile types.peripherals.sai_v4_4pdm.SAI = @ptrFromInt(0x58005400);
    ...
    /// PWR
    pub const PWR: *volatile types.peripherals.pwr_h7rm0468.PWR = @ptrFromInt(0x58024800);
