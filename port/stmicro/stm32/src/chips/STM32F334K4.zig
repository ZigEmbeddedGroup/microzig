...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "TIM7_DAC2", .index = 55, .description = null },
    .{ .name = "COMP2", .index = 64, .description = null },
    .{ .name = "COMP4_6", .index = 65, .description = null },
    .{ .name = "HRTIM1_Master", .index = 67, .description = null },
    .{ .name = "HRTIM1_TIMA", .index = 68, .description = null },
    .{ .name = "HRTIM1_TIMB", .index = 69, .description = null },
    .{ .name = "HRTIM1_TIMC", .index = 70, .description = null },
    .{ .name = "HRTIM1_TIMD", .index = 71, .description = null },
    .{ .name = "HRTIM1_TIME", .index = 72, .description = null },
    .{ .name = "HRTIM1_FLT", .index = 73, .description = null },
...
pub const VectorTable = extern struct {
    ...
    reserved56: [12]u32 = undefined,
    TIM6_DAC1: Handler = unhandled,
    TIM7_DAC2: Handler = unhandled,
    reserved70: [8]u32 = undefined,
    COMP2: Handler = unhandled,
    COMP4_6: Handler = unhandled,
    reserved80: [1]u32 = undefined,
