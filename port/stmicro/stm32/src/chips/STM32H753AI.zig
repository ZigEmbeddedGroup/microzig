...
pub const peripherals = struct {
    ...
    pub const RCC: *volatile types.peripherals.rcc_h7rm0433.RCC = @ptrFromInt(0x58024400);
    /// PWR
    pub const PWR: *volatile types.peripherals.pwr_h7rm0433.PWR = @ptrFromInt(0x58024800);
    ...
    /// HSEM.
    pub const HSEM: *volatile types.peripherals.hsem_v2.HSEM = @ptrFromInt(0x58026400);
    /// Debug support
