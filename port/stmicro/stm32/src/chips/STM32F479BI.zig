...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "QUADSPI", .index = 91, .description = null },
    .{ .name = "DSI", .index = 92, .description = null },
};
...
pub const peripherals = struct {
    ...
    /// Universal synchronous asynchronous receiver transmitter
    pub const UART4: *volatile types.peripherals.usart_v2.USART = @ptrFromInt(0x40004c00);
    /// Universal synchronous asynchronous receiver transmitter
    pub const UART5: *volatile types.peripherals.usart_v2.USART = @ptrFromInt(0x40005000);
    ...
    /// Universal synchronous asynchronous receiver transmitter
    pub const UART7: *volatile types.peripherals.usart_v2.USART = @ptrFromInt(0x40007800);
    /// Universal synchronous asynchronous receiver transmitter
    pub const UART8: *volatile types.peripherals.usart_v2.USART = @ptrFromInt(0x40007c00);
    ...
    /// Serial peripheral interface
    pub const SPI5: *volatile types.peripherals.spi_v1.SPI = @ptrFromInt(0x40015000);
    /// Serial peripheral interface
    pub const SPI6: *volatile types.peripherals.spi_v1.SPI = @ptrFromInt(0x40015400);
    ...
    /// Ethernet Peripheral
    pub const ETH: *volatile types.peripherals.eth_v1b.ETH = @ptrFromInt(0x40028000);
    /// DMA2D controller
