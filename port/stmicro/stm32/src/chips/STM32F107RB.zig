...
pub const peripherals = struct {
    ...
    pub const RCC: *volatile types.peripherals.rcc_f1cl.RCC = @ptrFromInt(0x40021000);
    /// FLASH
    ...
    /// Ethernet Peripheral
    pub const ETH: *volatile types.peripherals.eth_v1a.ETH = @ptrFromInt(0x40028000);
    /// USB on the go
