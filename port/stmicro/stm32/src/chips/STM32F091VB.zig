...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "DMA1_Ch1", .index = 9, .description = null },
    .{ .name = "DMA1_Ch2_3_DMA2_Ch1_2", .index = 10, .description = null },
    .{ .name = "DMA1_Ch4_7_DMA2_Ch3_5", .index = 11, .description = null },
    ...
    .{ .name = "USART3_8", .index = 29, .description = null },
...
pub const VectorTable = extern struct {
    ...
    DMA1_Ch4_7_DMA2_Ch3_5: Handler = unhandled,
...
pub const peripherals = struct {
    ...
    /// Universal synchronous asynchronous receiver transmitter
    pub const USART7: *volatile types.peripherals.usart_v3.USART = @ptrFromInt(0x40011800);
    /// Universal synchronous asynchronous receiver transmitter
    pub const USART8: *volatile types.peripherals.usart_v3.USART = @ptrFromInt(0x40011c00);
    ...
    pub const RCC: *volatile types.peripherals.rcc_f0v4.RCC = @ptrFromInt(0x40021000);
    /// Flash
