...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "OTG_HS", .index = 73, .description = null },
    ...
    .{ .name = "SDMMC2", .index = 79, .description = null },
    ...
    .{ .name = "MDF1_FLT2", .index = 104, .description = null },
    .{ .name = "MDF1_FLT3", .index = 105, .description = null },
    .{ .name = "UCPD1", .index = 106, .description = null },
    .{ .name = "ICACHE", .index = 107, .description = null },
    .{ .name = "OTFDEC1", .index = 108, .description = null },
    .{ .name = "OTFDEC2", .index = 109, .description = null },
    ...
    .{ .name = "DMA2D", .index = 118, .description = null },
    .{ .name = "DCMI_PSSI", .index = 119, .description = null },
    .{ .name = "OCTOSPI2", .index = 120, .description = null },
    .{ .name = "MDF1_FLT4", .index = 121, .description = null },
    .{ .name = "MDF1_FLT5", .index = 122, .description = null },
    .{ .name = "CORDIC", .index = 123, .description = null },
    .{ .name = "FMAC", .index = 124, .description = null },
    .{ .name = "LSECSSD", .index = 125, .description = null },
    .{ .name = "USART6", .index = 126, .description = null },
    .{ .name = "I2C5_ER", .index = 127, .description = null },
    .{ .name = "I2C5_EV", .index = 128, .description = null },
    .{ .name = "I2C6_ER", .index = 129, .description = null },
    .{ .name = "I2C6_EV", .index = 130, .description = null },
    .{ .name = "HSPI1", .index = 131, .description = null },
    .{ .name = "GPU2D", .index = 132, .description = null },
    .{ .name = "GPU2D_ER", .index = 133, .description = null },
    .{ .name = "GFXMMU", .index = 134, .description = null },
    .{ .name = "LTDC", .index = 135, .description = null },
    .{ .name = "LTDC_ER", .index = 136, .description = null },
    .{ .name = "DSI", .index = 137, .description = null },
    .{ .name = "DCACHE2", .index = 138, .description = null },
    .{ .name = "GFXTIM", .index = 139, .description = null },
    .{ .name = "JPEG", .index = 140, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    MDF1_FLT2: Handler = unhandled,
    MDF1_FLT3: Handler = unhandled,
    ...
    MDF1_FLT4: Handler = unhandled,
    MDF1_FLT5: Handler = unhandled,
    ...
    I2C6_ER: Handler = unhandled,
    I2C6_EV: Handler = unhandled,
    HSPI1: Handler = unhandled,
    GPU2D: Handler = unhandled,
    GPU2D_ER: Handler = unhandled,
    GFXMMU: Handler = unhandled,
    LTDC: Handler = unhandled,
    LTDC_ER: Handler = unhandled,
    DSI: Handler = unhandled,
    DCACHE2: Handler = unhandled,
...
pub const peripherals = struct {
    ...
    /// Inter-integrated circuit
    pub const I2C5: *volatile types.peripherals.i2c_v2.I2C = @ptrFromInt(0x40009800);
    /// Inter-integrated circuit
    pub const I2C6: *volatile types.peripherals.i2c_v2.I2C = @ptrFromInt(0x40009c00);
    ...
    /// LCD-TFT Controller
    pub const LTDC: *volatile types.peripherals.ltdc_v1.LTDC = @ptrFromInt(0x40016800);
    /// DSI Host.
    pub const DSIHOST: *volatile types.peripherals.dsihost_u5.DSIHOST = @ptrFromInt(0x40016c00);
    /// GPDMA
    ...
    /// JPEG codec
    pub const JPEG: *volatile types.peripherals.jpeg_v1.JPEG = @ptrFromInt(0x4002a000);
    /// DMA2D controller
    pub const DMA2D: *volatile types.peripherals.dma2d_v1.DMA2D = @ptrFromInt(0x4002b000);
    /// GFXMMU.
    pub const GFXMMU: *volatile types.peripherals.gfxmmu_v2.GFXMMU = @ptrFromInt(0x4002c000);
    ...
    /// Data cache.
    pub const DCACHE2: *volatile types.peripherals.dcache_v1.DCACHE = @ptrFromInt(0x40031800);
    ...
    /// General-purpose I/Os
    pub const GPIOJ: *volatile types.peripherals.gpio_v2.GPIO = @ptrFromInt(0x42022400);
    /// ADC.
    pub const ADC1: *volatile types.peripherals.adc_u5.ADC = @ptrFromInt(0x42028000);
    /// ADC.
    pub const ADC2: *volatile types.peripherals.adc_u5.ADC = @ptrFromInt(0x42028100);
    ...
    /// USB on the go
    pub const USB_OTG_HS: *volatile types.peripherals.otg_v1.OTG = @ptrFromInt(0x42040000);
    ...
    /// OctoSPI IO Manager
    pub const OCTOSPIM: *volatile types.peripherals.octospim_v1.OCTOSPIM = @ptrFromInt(0x420c4000);
    /// On-The-Fly Decryption engine.
    pub const OTFDEC1: *volatile types.peripherals.otfdec_v1.OTFDEC = @ptrFromInt(0x420c5000);
    /// On-The-Fly Decryption engine.
    pub const OTFDEC2: *volatile types.peripherals.otfdec_v1.OTFDEC = @ptrFromInt(0x420c5400);
    /// SDMMC
    pub const SDMMC1: *volatile types.peripherals.sdmmc_v2.SDMMC = @ptrFromInt(0x420c8000);
    /// SDMMC
    pub const SDMMC2: *volatile types.peripherals.sdmmc_v2.SDMMC = @ptrFromInt(0x420c8c00);
    /// OctoSPI
    pub const OCTOSPI1: *volatile types.peripherals.octospi_v1.OCTOSPI = @ptrFromInt(0x420d1400);
    /// OctoSPI
    pub const OCTOSPI2: *volatile types.peripherals.octospi_v1.OCTOSPI = @ptrFromInt(0x420d2400);
    ...
    /// Comparator.
    pub const COMP2: *volatile types.peripherals.comp_u5.COMP = @ptrFromInt(0x46005404);
