...
pub const peripherals = struct {
    ...
    pub const USB: *volatile types.peripherals.usb_v2.USB = @ptrFromInt(0x40005c00);
    /// USB Endpoint memory
    ...
    /// Operational Amplifier
    pub const OPAMP3: *volatile types.peripherals.opamp_f3.OPAMP = @ptrFromInt(0x40010040);
    /// Operational Amplifier
    pub const OPAMP4: *volatile types.peripherals.opamp_f3.OPAMP = @ptrFromInt(0x40010044);
    ...
    /// Advanced Control timers
    pub const TIM20: *volatile types.peripherals.timer_v1.TIM_ADV = @ptrFromInt(0x40015000);
    /// DMA controller
    ...
    pub const RCC: *volatile types.peripherals.rcc_f3v3.RCC = @ptrFromInt(0x40021000);
    /// Flash
    ...
    /// Analog-to-Digital Converter
    pub const ADC3: *volatile types.peripherals.adc_f3.ADC = @ptrFromInt(0x50000400);
    /// Analog-to-Digital Converter
    pub const ADC4: *volatile types.peripherals.adc_f3.ADC = @ptrFromInt(0x50000500);
    /// ADC common registers
    pub const ADC34_COMMON: *volatile types.peripherals.adccommon_f3.ADC_COMMON = @ptrFromInt(0x50000700);
    /// Debug support
