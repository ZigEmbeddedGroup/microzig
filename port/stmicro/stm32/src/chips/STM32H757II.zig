...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "CM7_SEV", .index = 64, .description = null },
    .{ .name = "CM4_SEV", .index = 65, .description = null },
    ...
    .{ .name = "DCMI", .index = 78, .description = null },
    .{ .name = "CRYP", .index = 79, .description = null },
    .{ .name = "HASH_RNG", .index = 80, .description = null },
    ...
    .{ .name = "OTG_FS_EP1_OUT", .index = 98, .description = null },
    .{ .name = "OTG_FS_EP1_IN", .index = 99, .description = null },
    .{ .name = "OTG_FS_WKUP", .index = 100, .description = null },
    .{ .name = "OTG_FS", .index = 101, .description = null },
    .{ .name = "DMAMUX1_OVR", .index = 102, .description = null },
    .{ .name = "HRTIM1_Master", .index = 103, .description = null },
    .{ .name = "HRTIM1_TIMA", .index = 104, .description = null },
    .{ .name = "HRTIM1_TIMB", .index = 105, .description = null },
    .{ .name = "HRTIM1_TIMC", .index = 106, .description = null },
    .{ .name = "HRTIM1_TIMD", .index = 107, .description = null },
    .{ .name = "HRTIM1_TIME", .index = 108, .description = null },
    .{ .name = "HRTIM1_FLT", .index = 109, .description = null },
    ...
    .{ .name = "SAI3", .index = 114, .description = null },
    ...
    .{ .name = "DSI", .index = 123, .description = null },
    .{ .name = "SDMMC2", .index = 124, .description = null },
    .{ .name = "HSEM1", .index = 125, .description = null },
    .{ .name = "HSEM2", .index = 126, .description = null },
    .{ .name = "ADC3", .index = 127, .description = null },
    .{ .name = "DMAMUX2_OVR", .index = 128, .description = null },
    .{ .name = "BDMA_Channel0", .index = 129, .description = null },
    .{ .name = "BDMA_Channel1", .index = 130, .description = null },
    .{ .name = "BDMA_Channel2", .index = 131, .description = null },
    .{ .name = "BDMA_Channel3", .index = 132, .description = null },
    .{ .name = "BDMA_Channel4", .index = 133, .description = null },
    .{ .name = "BDMA_Channel5", .index = 134, .description = null },
    .{ .name = "BDMA_Channel6", .index = 135, .description = null },
    .{ .name = "BDMA_Channel7", .index = 136, .description = null },
    .{ .name = "COMP", .index = 137, .description = null },
    .{ .name = "LPTIM2", .index = 138, .description = null },
    .{ .name = "LPTIM3", .index = 139, .description = null },
    .{ .name = "LPTIM4", .index = 140, .description = null },
    .{ .name = "LPTIM5", .index = 141, .description = null },
    ...
    .{ .name = "SAI4", .index = 146, .description = null },
    .{ .name = "HOLD_CORE", .index = 148, .description = null },
...
pub const VectorTable = extern struct {
    ...
    CM7_SEV: Handler = unhandled,
    CM4_SEV: Handler = unhandled,
    reserved80: [2]u32 = undefined,
    ...
    HRTIM1_Master: Handler = unhandled,
    HRTIM1_TIMA: Handler = unhandled,
    HRTIM1_TIMB: Handler = unhandled,
    HRTIM1_TIMC: Handler = unhandled,
    HRTIM1_TIMD: Handler = unhandled,
    HRTIM1_TIME: Handler = unhandled,
    ...
    DSI: Handler = unhandled,
    SDMMC2: Handler = unhandled,
    HSEM1: Handler = unhandled,
    HSEM2: Handler = unhandled,
    ADC3: Handler = unhandled,
    DMAMUX2_OVR: Handler = unhandled,
    BDMA_Channel0: Handler = unhandled,
    BDMA_Channel1: Handler = unhandled,
    BDMA_Channel2: Handler = unhandled,
    BDMA_Channel3: Handler = unhandled,
    BDMA_Channel4: Handler = unhandled,
    BDMA_Channel5: Handler = unhandled,
    BDMA_Channel6: Handler = unhandled,
    BDMA_Channel7: Handler = unhandled,
    ...
    reserved161: [1]u32 = undefined,
    HOLD_CORE: Handler = unhandled,
    WAKEUP_PIN: Handler = unhandled,
};

pub const peripherals = struct {
    /// Device Factory programmed 96-bit unique device identifier
    pub const UID: *volatile types.peripherals.uid_v1.UID = @ptrFromInt(0x1ff1e800);
    ...
    /// Window watchdog
    pub const WWDG2: *volatile types.peripherals.wwdg_v2.WWDG = @ptrFromInt(0x40002c00);
    ...
    /// Serial peripheral interface
    pub const SPI5: *volatile types.peripherals.spi_v3.SPI = @ptrFromInt(0x40015000);
    /// Serial audio interface
    pub const SAI1: *volatile types.peripherals.sai_v3_4pdm.SAI = @ptrFromInt(0x40015800);
    /// Serial audio interface
    pub const SAI2: *volatile types.peripherals.sai_v3_4pdm.SAI = @ptrFromInt(0x40015c00);
    /// Serial audio interface
    pub const SAI3: *volatile types.peripherals.sai_v3_4pdm.SAI = @ptrFromInt(0x40016000);
    /// High Resolution Timer
    pub const HRTIM1: *volatile types.peripherals.hrtim_v1.HRTIM = @ptrFromInt(0x40017400);
    /// DMA controller
    ...
    pub const CRYP: *volatile types.peripherals.cryp_v3.CRYP = @ptrFromInt(0x48021000);
    /// Hash processor.
    pub const HASH: *volatile types.peripherals.hash_v2.HASH = @ptrFromInt(0x48021400);
    ...
    /// DSI Host.
    pub const DSIHOST: *volatile types.peripherals.dsihost_v1.DSIHOST = @ptrFromInt(0x50000000);
    /// LCD-TFT Controller
    ...
    /// Flash
    pub const FLASH: *volatile types.peripherals.flash_h7.FLASH = @ptrFromInt(0x52002000);
    /// JPEG codec
    ...
    /// QuadSPI interface
    pub const QUADSPI: *volatile types.peripherals.quadspi_v1.QUADSPI = @ptrFromInt(0x52005000);
    /// SDMMC
    ...
    pub const SYSCFG: *volatile types.peripherals.syscfg_h7od.SYSCFG = @ptrFromInt(0x58000400);
    ...
    /// Low power timer with Output Compare
    pub const LPTIM5: *volatile types.peripherals.lptim_v1b_h7.LPTIM = @ptrFromInt(0x58003000);
    /// COMP1.
    pub const COMP1: *volatile types.peripherals.comp_h7_b.COMP = @ptrFromInt(0x5800380c);
    /// COMP1.
    pub const COMP2: *volatile types.peripherals.comp_h7_b.COMP = @ptrFromInt(0x58003810);
    ...
    /// Independent watchdog
    pub const IWDG2: *volatile types.peripherals.iwdg_v2.IWDG = @ptrFromInt(0x58004c00);
    /// Serial audio interface
    pub const SAI4: *volatile types.peripherals.sai_v3_4pdm.SAI = @ptrFromInt(0x58005400);
    ...
    pub const RCC: *volatile types.peripherals.rcc_h7.RCC = @ptrFromInt(0x58024400);
    /// PWR
    pub const PWR: *volatile types.peripherals.pwr_h7rm0399.PWR = @ptrFromInt(0x58024800);
    /// Cyclic Redundancy Check calculation unit
    pub const CRC: *volatile types.peripherals.crc_v3.CRC = @ptrFromInt(0x58024c00);
    /// DMA controller
    pub const BDMA: *volatile types.peripherals.bdma_v1.DMA = @ptrFromInt(0x58025400);
    /// DMAMUX
    pub const DMAMUX2: *volatile types.peripherals.dmamux_v1.DMAMUX = @ptrFromInt(0x58025800);
    /// Analog to Digital Converter
    pub const ADC3: *volatile types.peripherals.adc_v4.ADC = @ptrFromInt(0x58026000);
    /// Analog-to-Digital Converter
    pub const ADC3_COMMON: *volatile types.peripherals.adccommon_v4.ADC_COMMON = @ptrFromInt(0x58026300);
    /// Hardware semaphore (HSEM).
    pub const HSEM: *volatile types.peripherals.hsem_v1.HSEM = @ptrFromInt(0x58026400);
    /// Debug support
