...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "DMA1_Ch4_7_DMAMUX_OVR", .index = 11, .description = null },
    .{ .name = "ADC_COMP1", .index = 12, .description = null },
    ...
    .{ .name = "TIM15", .index = 19, .description = null },
    ...
    .{ .name = "USART4", .index = 30, .description = null },
    .{ .name = "RNG", .index = 31, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    DMA1_Ch4_7_DMAMUX_OVR: Handler = unhandled,
    ADC_COMP1: Handler = unhandled,
    ...
    USART4: Handler = unhandled,
    RNG: Handler = unhandled,
};

pub const peripherals = struct {
    /// Device Factory programmed 96-bit unique device identifier
    pub const UID: *volatile types.peripherals.uid_v1.UID = @ptrFromInt(0x1fff3e50);
