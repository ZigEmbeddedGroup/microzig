...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "HRTIM1_TIMF", .index = 74, .description = null },
...
pub const peripherals = struct {
    ...
    pub const HRTIM1: *volatile types.peripherals.hrtim_v2.HRTIM = @ptrFromInt(0x40016800);
    /// DMA controller
