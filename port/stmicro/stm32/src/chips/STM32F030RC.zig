...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "USART3_6", .index = 29, .description = null },
};
...
pub const peripherals = struct {
    ...
    /// Power control
    pub const PWR: *volatile types.peripherals.pwr_f0x0.PWR = @ptrFromInt(0x40007000);
    ...
    pub const RCC: *volatile types.peripherals.rcc_f0v3.RCC = @ptrFromInt(0x40021000);
    /// Flash
