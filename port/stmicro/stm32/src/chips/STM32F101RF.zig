...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "TIM9", .index = 24, .description = null },
    .{ .name = "TIM10", .index = 25, .description = null },
    .{ .name = "TIM11", .index = 26, .description = null },
...
pub const peripherals = struct {
    ...
    /// 2-channel timers
    pub const TIM9: *volatile types.peripherals.timer_v1.TIM_2CH = @ptrFromInt(0x40014c00);
    /// 1-channel timers
    pub const TIM10: *volatile types.peripherals.timer_v1.TIM_1CH = @ptrFromInt(0x40015000);
    /// 1-channel timers
    pub const TIM11: *volatile types.peripherals.timer_v1.TIM_1CH = @ptrFromInt(0x40015400);
    /// DMA controller
