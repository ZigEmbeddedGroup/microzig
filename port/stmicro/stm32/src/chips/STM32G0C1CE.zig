...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "PVD_VDDIO2", .index = 1, .description = null },
    ...
    .{ .name = "USB_UCPD1_2", .index = 8, .description = null },
    ...
    .{ .name = "TIM16_FDCAN_IT0", .index = 21, .description = null },
    .{ .name = "TIM17_FDCAN_IT1", .index = 22, .description = null },
    ...
    .{ .name = "USART3_4_5_6_LPUART1", .index = 29, .description = null },
    .{ .name = "CEC", .index = 30, .description = null },
    .{ .name = "AES_RNG", .index = 31, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    TIM16_FDCAN_IT0: Handler = unhandled,
    TIM17_FDCAN_IT1: Handler = unhandled,
    ...
    USART3_4_5_6_LPUART1: Handler = unhandled,
...
pub const peripherals = struct {
    ...
    /// FDCAN Message RAM
    pub const FDCANRAM1: *volatile types.peripherals.fdcanram_v1.FDCANRAM = @ptrFromInt(0x4000b400);
    /// FDCAN Message RAM
    pub const FDCANRAM2: *volatile types.peripherals.fdcanram_v1.FDCANRAM = @ptrFromInt(0x4000b750);
    ...
    /// Comparator v1. (RM0444 18)
    pub const COMP3: *volatile types.peripherals.comp_v1.COMP = @ptrFromInt(0x40010208);
