...
pub const peripherals = struct {
    ...
    /// Real-time clock
    pub const RTC: *volatile types.peripherals.rtc_v2f2.RTC = @ptrFromInt(0x40002800);
    /// Window watchdog
    ...
    /// Power control
    pub const PWR: *volatile types.peripherals.pwr_f2.PWR = @ptrFromInt(0x40007000);
    ...
    pub const SYSCFG: *volatile types.peripherals.syscfg_f2.SYSCFG = @ptrFromInt(0x40013800);
    ...
    pub const RCC: *volatile types.peripherals.rcc_f2.RCC = @ptrFromInt(0x40023800);
    /// FLASH
    pub const FLASH: *volatile types.peripherals.flash_f2.FLASH = @ptrFromInt(0x40023c00);
    /// DMA controller
    ...
    pub const CRYP: *volatile types.peripherals.cryp_v1.CRYP = @ptrFromInt(0x50060000);
    /// Hash processor.
    pub const HASH: *volatile types.peripherals.hash_v1.HASH = @ptrFromInt(0x50060400);
    ...
    /// Debug support
    pub const DBGMCU: *volatile types.peripherals.dbgmcu_f2.DBGMCU = @ptrFromInt(0xe0042000);
};
