...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "CAN3_TX", .index = 74, .description = null },
    .{ .name = "CAN3_RX0", .index = 75, .description = null },
    .{ .name = "CAN3_RX1", .index = 76, .description = null },
    .{ .name = "CAN3_SCE", .index = 77, .description = null },
    ...
    .{ .name = "UART9", .index = 88, .description = null },
    .{ .name = "UART10", .index = 89, .description = null },
    ...
    .{ .name = "DFSDM2_FLT0", .index = 98, .description = null },
    .{ .name = "DFSDM2_FLT1", .index = 99, .description = null },
    .{ .name = "DFSDM2_FLT2", .index = 100, .description = null },
    .{ .name = "DFSDM2_FLT3", .index = 101, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    UART10: Handler = unhandled,
    reserved104: [2]u32 = undefined,
    QUADSPI: Handler = unhandled,
    reserved107: [2]u32 = undefined,
    FMPI2C1_EV: Handler = unhandled,
    FMPI2C1_ER: Handler = unhandled,
    LPTIM1: Handler = unhandled,
    DFSDM2_FLT0: Handler = unhandled,
    DFSDM2_FLT1: Handler = unhandled,
    DFSDM2_FLT2: Handler = unhandled,
    DFSDM2_FLT3: Handler = unhandled,
};
...
pub const peripherals = struct {
    ...
    /// Controller area network
    pub const CAN3: *volatile types.peripherals.can_bxcan.CAN = @ptrFromInt(0x40006c00);
    /// Power control
    ...
    /// Universal synchronous asynchronous receiver transmitter
    pub const UART9: *volatile types.peripherals.usart_v2.USART = @ptrFromInt(0x40011800);
    /// Universal synchronous asynchronous receiver transmitter
    pub const UART10: *volatile types.peripherals.usart_v2.USART = @ptrFromInt(0x40011c00);
