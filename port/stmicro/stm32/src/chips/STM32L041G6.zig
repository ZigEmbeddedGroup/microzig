...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "AES_LPUART1", .index = 29, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    reserved40: [2]u32 = undefined,
    USART2: Handler = unhandled,
    AES_LPUART1: Handler = unhandled,
};
...
pub const peripherals = struct {
    ...
    pub const AES: *volatile types.peripherals.aes_v1.AES = @ptrFromInt(0x40026000);
