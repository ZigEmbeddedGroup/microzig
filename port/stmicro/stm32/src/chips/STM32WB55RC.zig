...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "I2C3_EV", .index = 32, .description = null },
    .{ .name = "I2C3_ER", .index = 33, .description = null },
    ...
    .{ .name = "SAI1", .index = 38, .description = null },
    .{ .name = "TSC", .index = 39, .description = null },
    .{ .name = "EXTI15_10", .index = 40, .description = null },
    .{ .name = "RTC_Alarm", .index = 41, .description = null },
    .{ .name = "CRS", .index = 42, .description = null },
    .{ .name = "PWR_SOTF_BLEACT_802ACT_RFPHASE", .index = 43, .description = null },
    ...
    .{ .name = "LCD", .index = 49, .description = null },
    .{ .name = "QUADSPI", .index = 50, .description = null },
    .{ .name = "AES1", .index = 51, .description = null },
    .{ .name = "AES2", .index = 52, .description = null },
    .{ .name = "RNG", .index = 53, .description = null },
    .{ .name = "FPU", .index = 54, .description = null },
    .{ .name = "DMA2_Channel1", .index = 55, .description = null },
    .{ .name = "DMA2_Channel2", .index = 56, .description = null },
    .{ .name = "DMA2_Channel3", .index = 57, .description = null },
    .{ .name = "DMA2_Channel4", .index = 58, .description = null },
    .{ .name = "DMA2_Channel5", .index = 59, .description = null },
    .{ .name = "DMA2_Channel6", .index = 60, .description = null },
    .{ .name = "DMA2_Channel7", .index = 61, .description = null },
...
pub const VectorTable = extern struct {
    ...
    PWR_SOTF_BLEACT_802ACT_RFPHASE: Handler = unhandled,
...
pub const peripherals = struct {
    ...
    /// Power control
    pub const PWR: *volatile types.peripherals.pwr_wb55.PWR = @ptrFromInt(0x58000400);
    ...
    pub const HSEM: *volatile types.peripherals.hsem_v1.HSEM = @ptrFromInt(0x58001400);
    ...
    /// QuadSPI interface
    pub const QUADSPI: *volatile types.peripherals.quadspi_v1.QUADSPI = @ptrFromInt(0x90000000);
    /// Debug support
