...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "LCD", .index = 78, .description = null },
    ...
    .{ .name = "I2C4_EV", .index = 83, .description = null },
    .{ .name = "I2C4_ER", .index = 84, .description = null },
    .{ .name = "DCMI", .index = 85, .description = null },
    .{ .name = "CAN2_TX", .index = 86, .description = null },
    .{ .name = "CAN2_RX0", .index = 87, .description = null },
    .{ .name = "CAN2_RX1", .index = 88, .description = null },
    .{ .name = "CAN2_SCE", .index = 89, .description = null },
