...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "TIM3", .index = 42, .description = null },
    .{ .name = "I2C1_EV", .index = 43, .description = null },
    .{ .name = "I2C1_ER", .index = 44, .description = null },
    .{ .name = "SPI1", .index = 45, .description = null },
    .{ .name = "USART1", .index = 46, .description = null },
    .{ .name = "USART2", .index = 47, .description = null },
    .{ .name = "LPUART1", .index = 48, .description = null },
    .{ .name = "LPTIM1", .index = 49, .description = null },
    .{ .name = "LPTIM2", .index = 50, .description = null },
    .{ .name = "TIM16", .index = 51, .description = null },
    .{ .name = "TIM17", .index = 52, .description = null },
    .{ .name = "COMP", .index = 53, .description = null },
    ...
    .{ .name = "HSEM_S", .index = 69, .description = null },
    .{ .name = "WKUP_S", .index = 70, .description = null },
    .{ .name = "RCC_AUDIOSYNC", .index = 71, .description = null },
};
...
pub const VectorTable = extern struct {
    ...
    HSEM_S: Handler = unhandled,
    WKUP_S: Handler = unhandled,
    RCC_AUDIOSYNC: Handler = unhandled,
};
