...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "LTDC", .index = 96, .description = null },
    .{ .name = "LTDC_ER", .index = 97, .description = null },
    ...
    .{ .name = "GPU2D", .index = 149, .description = null },
    .{ .name = "GPU2D_ER", .index = 150, .description = null },
    .{ .name = "ICACHE", .index = 151, .description = null },
...
pub const peripherals = struct {
    ...
    pub const UCPD1: *volatile types.peripherals.ucpd_v1.UCPD = @ptrFromInt(0x4000ec00);
    /// GPDMA
    ...
    /// Serial peripheral interface
    pub const SPI4: *volatile types.peripherals.spi_v4.SPI = @ptrFromInt(0x42003400);
    ...
    pub const TIM16: *volatile types.peripherals.timer_v1.TIM_1CH_CMP = @ptrFromInt(0x42004400);
    /// 1-channel with one complementary output timers
    ...
    pub const SAI1: *volatile types.peripherals.sai_v4_4pdm.SAI = @ptrFromInt(0x42005800);
    /// Serial audio interface
    pub const SAI2: *volatile types.peripherals.sai_v4_4pdm.SAI = @ptrFromInt(0x42005c00);
    /// Parallel synchronous slave interface.
    pub const PSSI: *volatile types.peripherals.pssi_v1.PSSI = @ptrFromInt(0x48000400);
    /// SDMMC
    pub const SDMMC2: *volatile types.peripherals.sdmmc_v2.SDMMC = @ptrFromInt(0x48002400);
    /// CORDIC co-processor.
    ...
    /// Serial peripheral interface
    pub const SPI6: *volatile types.peripherals.spi_v4.SPI = @ptrFromInt(0x58001400);
    /// Low power timer with Output Compare
