...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "SAES", .index = 36, .description = null },
    ...
    .{ .name = "OTFDEC1", .index = 115, .description = null },
    .{ .name = "AES", .index = 116, .description = null },
...
pub const peripherals = struct {
    ...
    /// Universal synchronous asynchronous receiver transmitter
    pub const USART10: *volatile types.peripherals.usart_v4.USART = @ptrFromInt(0x40006800);
    /// Universal synchronous asynchronous receiver transmitter
    ...
    /// Serial peripheral interface
    pub const SPI4: *volatile types.peripherals.spi_v4.SPI = @ptrFromInt(0x40014c00);
    /// Serial peripheral interface
    ...
    pub const SAES: *volatile types.peripherals.saes_v1a.SAES = @ptrFromInt(0x420c0c00);
    ...
    /// Serial peripheral interface
    pub const SPI5: *volatile types.peripherals.spi_v4.SPI = @ptrFromInt(0x44002000);
    ...
    pub const OTFDEC1: *volatile types.peripherals.otfdec_v1.OTFDEC = @ptrFromInt(0x46005000);
    /// SDMMC
    pub const SDMMC1: *volatile types.peripherals.sdmmc_v2.SDMMC = @ptrFromInt(0x46008000);
    /// SDMMC
    pub const SDMMC2: *volatile types.peripherals.sdmmc_v2.SDMMC = @ptrFromInt(0x46008c00);
    /// OctoSPI
