...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "DSI", .index = 78, .description = null },
...
pub const peripherals = struct {
    ...
    /// GFXMMU.
    pub const GFXMMU: *volatile types.peripherals.gfxmmu_v1.GFXMMU = @ptrFromInt(0x4002c000);
