...
pub const interrupts: []const Interrupt = &.{
    ...
    .{ .name = "COMP4", .index = 65, .description = null },
...
pub const VectorTable = extern struct {
    ...
    COMP4: Handler = unhandled,
    reserved80: [9]u32 = undefined,
...
pub const peripherals = struct {
    ...
    /// Flash
    pub const FLASH: *volatile types.peripherals.flash_g4c4.FLASH = @ptrFromInt(0x40022000);
