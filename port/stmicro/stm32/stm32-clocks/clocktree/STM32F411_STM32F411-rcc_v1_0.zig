...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            var VCOInputMFreq_ValueLimit: Limit = .{};
            //Ref Values
            ...
            const VCOInputMFreq_ValueValue: ?f32 = blk: {
                if ((I2SSourceIsPll and config.flags.I2SUsed_ForRCC) or ((check_ref(@TypeOf(RCC_MCO2SourceValue), RCC_MCO2SourceValue, .RCC_MCO2SOURCE_PLLI2SCLK, .@"=")) and config.flags.MCO2Config)) {
                    VCOInputMFreq_ValueLimit = .{
                        .min = 9.5e5,
                        .max = 2.1e6,
                    };
                    break :blk null;
            ...
            std.mem.doNotOptimizeAway(VCOInputMFreq_ValueValue);
            VCOInputM.limit = VCOInputMFreq_ValueLimit;
