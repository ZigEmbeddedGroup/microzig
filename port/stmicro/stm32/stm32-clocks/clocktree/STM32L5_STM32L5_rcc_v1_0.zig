    ...
    return struct {
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if ((SysSourceMSI and ((check_ref(?f32, SysCLKOutput.get_as_ref(), 24000000, .@"<")) or (check_ref(?f32, SysCLKOutput.get_as_ref(), 24000000, .@"=")))) or (SysSourceHSE and ((check_ref(?f32, SysCLKOutput.get_as_ref(), 26000000, .@"<")) or (check_ref(?f32, SysCLKOutput.get_as_ref(), 26000000, .@"="))))) {
                ...
                } else if ((SysSourceMSI and check_ref(?f32, SysCLKOutput.get_as_ref(), 24000000, .@">")) or (SysSourceHSE and (check_ref(?f32, SysCLKOutput.get_as_ref(), 26000000, .@">")) and (check_ref(?f32, SysCLKOutput.get_as_ref(), 48000000, .@"<")) or (check_ref(?f32, SysCLKOutput.get_as_ref(), 48000000, .@"=")))) {
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |item| {
                        switch (item) {
                            .PWR_REGULATOR_VOLTAGE_SCALE1 => scale1 = true,
                ...
                } else if ((check_ref(?f32, AHBOutput.get_as_ref(), 80000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 80000000, .@"="))) {
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |item| {
                        switch (item) {
                            .PWR_REGULATOR_VOLTAGE_SCALE0 => scale0 = true,
            ...
            const FLatencyValue: ?FLatencyList = blk: {
                if ((scale2 and ((check_ref(?f32, AHBOutput.get_as_ref(), 8000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 8000000, .@"="))))) {
                    ...
                    break :blk item;
                } else if ((scale1 and ((check_ref(?f32, AHBOutput.get_as_ref(), 20000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 20000000, .@"<"))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_0 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_0;
                } else if ((scale1 and ((check_ref(?f32, AHBOutput.get_as_ref(), 40000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 40000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_1 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_1;
                } else if ((scale1 and ((check_ref(?f32, AHBOutput.get_as_ref(), 60000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 60000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_2 => {},
                ...
                } else if ((scale1 and ((check_ref(?f32, AHBOutput.get_as_ref(), 80000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 80000000, .@"="))))) {
                    ...
                    break :blk item;
                } else if ((scale0 and ((check_ref(?f32, AHBOutput.get_as_ref(), 20000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 20000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_0;
                } else if ((scale0 and ((check_ref(?f32, AHBOutput.get_as_ref(), 40000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 40000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_1;
                } else if ((scale0 and ((check_ref(?f32, AHBOutput.get_as_ref(), 60000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 60000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_2;
                } else if ((scale0 and ((check_ref(?f32, AHBOutput.get_as_ref(), 80000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 80000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
                ...
                } else if ((scale0 and ((check_ref(?f32, AHBOutput.get_as_ref(), 100000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 100000000, .@"="))))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
            ...
            ref_out.flags.RCC_TZ_PRIV = config.flags.RCC_TZ_PRIV;
