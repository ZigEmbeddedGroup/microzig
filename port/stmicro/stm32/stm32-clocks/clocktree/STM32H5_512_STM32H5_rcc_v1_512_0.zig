...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            ref_out.flags.LPTIM3Enable = config.flags.LPTIM3Enable;
            ref_out.flags.LPTIM4Enable = config.flags.LPTIM4Enable;
            ref_out.flags.LPTIM5Enable = config.flags.LPTIM5Enable;
            ref_out.flags.LPTIM6Enable = config.flags.LPTIM6Enable;
            ...
            ref_out.flags.CEC_Used = config.flags.CEC_Used;
