...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Flag_Output = struct {
            ...
            SMPSEnable: bool = false,
            SMPSDivEnable: bool = false,
            ...
            HSIUsed: bool = false,
            MSIUsed: bool = false,
            MSIUsedForSys: bool = false,
            HSIUsedForSys: bool = false,
            LSEUsed: bool = false,
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            const LSE_VALUEValue: ?f32 = if (config.LSE_VALUE) |i| i else 32774;
            ...
            const PLLNValue: ?f32 = if (config.PLLN) |i| @as(f32, @floatFromInt(i)) else 8;
            ...
            _ = blk: {
                if (check_MCU("STM32WBx0_Value_Line")) {
                    ...
                    PLLN.value = if (config_val) |i| @as(f32, @floatFromInt(i)) else 8;
            ...
            const FLatencyValue: ?FLatencyList = blk: {
                if (((scale1 or check_MCU("STM32WBx0_Value_Line")) and ((check_ref(?f32, AHB3Output.get_as_ref(), 18000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 18000000, .@"=")))) or (scale2 and ((check_ref(?f32, AHB3Output.get_as_ref(), 6000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 6000000, .@"="))))) {
                    const item: FLatencyList = .FLASH_LATENCY_0;
                    break :blk item;
                } else if (((scale1 or check_MCU("STM32WBx0_Value_Line")) and ((check_ref(?f32, AHB3Output.get_as_ref(), 36000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 36000000, .@"=")))) or (scale2 and ((check_ref(?f32, AHB3Output.get_as_ref(), 12000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 12000000, .@"="))))) {
                    const item: FLatencyList = .FLASH_LATENCY_1;
                    break :blk item;
                } else if (((scale1 or check_MCU("STM32WBx0_Value_Line")) and ((check_ref(?f32, AHB3Output.get_as_ref(), 54000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 54000000, .@"=")))) or (scale2 and ((check_ref(?f32, AHB3Output.get_as_ref(), 16000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 16000000, .@"="))))) {
                    const item: FLatencyList = .FLASH_LATENCY_2;
                    break :blk item;
                } else if (((scale1 or check_MCU("STM32WBx0_Value_Line")) and ((check_ref(?f32, AHB3Output.get_as_ref(), 64000000, .@"<")) or (check_ref(?f32, AHB3Output.get_as_ref(), 64000000, .@"="))))) {
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if (check_MCU("STM32WBx0_Value_Line")) {
                    ...
                    break :blk null;
                } else if (((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@"<")) or (check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@"="))) and !check_MCU("STM32WBx0_Value_Line")) {
                ...
                } else if ((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@">")) and !check_MCU("STM32WBx0_Value_Line")) {
                    scale1 = true;
            ...
            ref_out.flags.RFUsed_ForRCC = config.flags.RFUsed_ForRCC;
            ...
            ref_out.flags.SDMMCEnable = config.flags.SDMMCEnable;
            ...
            ref_out.flags.SMPSEnable = check_ref(?SMPSEnableList, SMPSEnableValue, .true, .@"=");
            ref_out.flags.SMPSDivEnable = check_ref(?SMPSDivEnableList, SMPSDivEnableValue, .true, .@"=");
            ...
            ref_out.flags.MSIUsedForSys = check_ref(?f32, MSIUsedForSysValue, 1, .@"=");
            ref_out.flags.HSIUsedForSys = check_ref(?f32, HSIUsedForSysValue, 1, .@"=");
