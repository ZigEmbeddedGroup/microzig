...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            const CDCPRE_clk_value = CDCPREValue orelse return comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const CDPPRE_clk_value = CDPPREValue orelse return comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const CDPPRE1_clk_value = CDPPRE1Value orelse return comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const CDPPRE2_clk_value = CDPPRE2Value orelse return comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            const SRDPPRE_clk_value = SRDPPREValue orelse return comptime_fail_or_error(error.InvalidClockValue,
                \\Error on Clock {s} | expr: {s} diagnostic: {s}
                \\Clock is active but the reference value {s} is null
                \\note: check the flags and configurations associated with this clock
                \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(SAI2BEnableValue), SAI2BEnableValue, .true, .@"=")) {
                const SAI2BMult_clk_value = SAI2BCLockSelectionValue orelse return comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(SAI2AEnableValue), SAI2AEnableValue, .true, .@"=")) {
                const SAI2AMult_clk_value = SAI2ACLockSelectionValue orelse return comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            if (check_ref(@TypeOf(DFSDM2EnableValue), DFSDM2EnableValue, .true, .@"=")) {
                const DFSDM2Mult_clk_value = DFSDM2CLockSelectionValue orelse return comptime_fail_or_error(error.InvalidClockValue,
                    \\Error on Clock {s} | expr: {s} diagnostic: {s}
                    \\Clock is active but the reference value {s} is null
                    \\note: check the flags and configurations associated with this clock
                    \\note2: actually I'm not sure if null values and clock nodes should be treated as errors.
            ...
            //POST CLOCK REF TraceFreq_Value VALUE
            _ = blk: {
                if (scale0) {
                ...
                TraceCLKOutput.value = 96000000;
                break :blk null;
            };

            //POST CLOCK REF CDCPREFreq_Value VALUE
            _ = blk: {
                CDCPREOutput.limit = .{
                    .min = null,
                    .max = 2.8e8,
            ...
            //POST CLOCK REF DAC1Freq_Value VALUE
            _ = blk: {
                if (scale0) {
                    DAC1Output.limit = .{
                        .min = null,
                ...
                DAC1Output.value = 32000;
                break :blk null;
            };

            //POST CLOCK REF DAC2Freq_Value VALUE
            _ = blk: {
                if (scale0) {
                    DAC2Output.limit = .{
                        .min = null,
            ...
            _ = blk: {
                ...
                SAI1output.value = 96000000;
                break :blk null;
            };

            //POST CLOCK REF SAI2BFreq_Value VALUE
            _ = blk: {
                if (scale0) {
                    SAI2Boutput.limit = .{
                        .min = null,
                ...
                SAI2Boutput.value = 96000000;
                break :blk null;
            };

            //POST CLOCK REF SAI2AFreq_Value VALUE
            _ = blk: {
                if (scale0) {
                    SAI2Aoutput.limit = .{
                        .min = null,
            ...
            _ = blk: {
                ...
                DFSDMoutput.value = 96000000;
                break :blk null;
            };

            //POST CLOCK REF DFSDM2Freq_Value VALUE
            _ = blk: {
                if (scale0) {
                    DFSDM2output.limit = .{
                        .min = null,
            ...
            _ = blk: {
                ...
                USART234578output.value = 96000000;
                break :blk null;
            };
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                if ((check_ref(?f32, CpuClockOutput.get_as_ref(), 88000000, .@"<")) or (check_ref(?f32, CpuClockOutput.get_as_ref(), 88000000, .@"="))) {
                ...
                } else if (((check_ref(?f32, CpuClockOutput.get_as_ref(), 160000000, .@"<")) or (check_ref(?f32, CpuClockOutput.get_as_ref(), 160000000, .@"="))) and (check_ref(?f32, CpuClockOutput.get_as_ref(), 88000000, .@">"))) {
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |item| {
                        switch (item) {
                            .PWR_REGULATOR_VOLTAGE_SCALE0 => scale0 = true,
                ...
                } else if (((check_ref(?f32, CpuClockOutput.get_as_ref(), 225000000, .@"<")) or (check_ref(?f32, CpuClockOutput.get_as_ref(), 225000000, .@"="))) and (check_ref(?f32, CpuClockOutput.get_as_ref(), 160000000, .@">"))) {
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |item| {
                        switch (item) {
                            .PWR_REGULATOR_VOLTAGE_SCALE0 => scale0 = true,
                ...
                } else if (((check_ref(?f32, CpuClockOutput.get_as_ref(), 280000000, .@"<")) or (check_ref(?f32, CpuClockOutput.get_as_ref(), 280000000, .@"="))) and (check_ref(?f32, CpuClockOutput.get_as_ref(), 225000000, .@">"))) {
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |item| {
                        switch (item) {
                            .PWR_REGULATOR_VOLTAGE_SCALE3 => {},
                ...
                } else if ((check_ref(?f32, CpuClockOutput.get_as_ref(), 280000000, .@">"))) {
                    scale0 = true;
            ...
            const FLatencyValue: ?FLatencyList = blk: {
                if ((scale0 and (check_ref(?f32, AHBOutput.get_as_ref(), 252000000, .@">")))) {
                    ...
                    break :blk item;
                } else if ((scale0 and (check_ref(?f32, AHBOutput.get_as_ref(), 210000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
                ...
                } else if ((scale0 and (check_ref(?f32, AHBOutput.get_as_ref(), 168000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_4 => {},
                ...
                } else if ((scale0 and (check_ref(?f32, AHBOutput.get_as_ref(), 126000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_3 => {},
                ...
                } else if ((scale0 and (check_ref(?f32, AHBOutput.get_as_ref(), 84000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_2 => {},
                ...
                } else if ((scale0 and (check_ref(?f32, AHBOutput.get_as_ref(), 42000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_1 => {},
                ...
                } else if ((scale1 and (check_ref(?f32, AHBOutput.get_as_ref(), 190000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_5 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_5;
                } else if ((scale1 and (check_ref(?f32, AHBOutput.get_as_ref(), 152000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_4 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_4;
                } else if ((scale1 and (check_ref(?f32, AHBOutput.get_as_ref(), 114000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_3 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_3;
                } else if ((scale1 and (check_ref(?f32, AHBOutput.get_as_ref(), 76000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_2 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_2;
                } else if ((scale1 and (check_ref(?f32, AHBOutput.get_as_ref(), 38000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_1 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_1;
                } else if ((scale2 and (check_ref(?f32, AHBOutput.get_as_ref(), 136000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_4 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_4;
                } else if ((scale2 and (check_ref(?f32, AHBOutput.get_as_ref(), 102000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_3 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_3;
                } else if ((scale2 and (check_ref(?f32, AHBOutput.get_as_ref(), 68000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_2 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_2;
                } else if ((scale2 and (check_ref(?f32, AHBOutput.get_as_ref(), 34000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_1 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_1;
                } else if ((scale3 and (check_ref(?f32, AHBOutput.get_as_ref(), 66000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_3 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_3;
                } else if ((scale3 and (check_ref(?f32, AHBOutput.get_as_ref(), 44000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_2 => {},
                    ...
                    break :blk conf_item orelse .FLASH_LATENCY_2;
                } else if ((scale3 and (check_ref(?f32, AHBOutput.get_as_ref(), 22000000, .@">")))) {
                    const conf_item = config.extra.FLatency;
                    if (conf_item) |item| {
                        switch (item) {
                            .FLASH_LATENCY_1 => {},
            ...
            const PLL1_VCO_SELValue: ?PLL1_VCO_SELList = blk: {
                if ((check_ref(?f32, VCOInput.get_as_ref(), 1000000, .@">") or (check_ref(?f32, VCOInput.get_as_ref(), 1000000, .@"="))) and (check_ref(?f32, VCOInput.get_as_ref(), 2000000, .@"<")) and ((check_ref(?f32, VCO1Output.get_as_ref(), 150000000, .@">")) or (check_ref(?f32, VCO1Output.get_as_ref(), 150000000, .@"="))) and ((check_ref(?f32, VCO1Output.get_as_ref(), 420000000, .@">") or (check_ref(?f32, VCO1Output.get_as_ref(), 420000000, .@"=")))) and check_ref(@TypeOf(PLLUsedValue), PLLUsedValue, 1, .@"=")) {
                    pll1meduim = true;
            ...
            const PLL2_VCO_SELValue: ?PLL2_VCO_SELList = blk: {
                if ((check_ref(?f32, VCO2Input.get_as_ref(), 1000000, .@">") or (check_ref(?f32, VCO2Input.get_as_ref(), 1000000, .@"="))) and (check_ref(?f32, VCO2Input.get_as_ref(), 2000000, .@"<")) and ((check_ref(?f32, VCO2Output.get_as_ref(), 150000000, .@">")) or (check_ref(?f32, VCO2Output.get_as_ref(), 150000000, .@"="))) and ((check_ref(?f32, VCO2Output.get_as_ref(), 420000000, .@">") or (check_ref(?f32, VCO2Output.get_as_ref(), 420000000, .@"=")))) and check_ref(@TypeOf(PLL2UsedValue), PLL2UsedValue, 1, .@"=")) {
            ...
            const PLL3_VCO_SELValue: ?PLL3_VCO_SELList = blk: {
                if ((check_ref(?f32, VCO3Input.get_as_ref(), 1000000, .@">") or (check_ref(?f32, VCO3Input.get_as_ref(), 1000000, .@"="))) and (check_ref(?f32, VCO3Input.get_as_ref(), 2000000, .@"<")) and ((check_ref(?f32, VCO3Output.get_as_ref(), 150000000, .@">")) or (check_ref(?f32, VCO3Output.get_as_ref(), 150000000, .@"="))) and ((check_ref(?f32, VCO3Output.get_as_ref(), 420000000, .@">") or (check_ref(?f32, VCO3Output.get_as_ref(), 420000000, .@"=")))) and check_ref(@TypeOf(PLL3UsedValue), PLL3UsedValue, 1, .@"=")) {
            ...
            ref_out.flags.DFSDM2Used_ForRCC = config.flags.DFSDM2Used_ForRCC;
            ...
            ref_out.flags.SAI2AEnable = check_ref(?SAI2AEnableList, SAI2AEnableValue, .true, .@"=");
            ref_out.flags.SAI2BEnable = check_ref(?SAI2BEnableList, SAI2BEnableValue, .true, .@"=");
            ...
            ref_out.flags.OCSPIEnable = check_ref(?OCSPIEnableList, OCSPIEnableValue, .true, .@"=");
            ...
            ref_out.flags.USART16910Enable = check_ref(?USART16910EnableList, USART16910EnableValue, .true, .@"=");
            ...
            ref_out.flags.I2C123Enable = check_ref(?I2C123EnableList, I2C123EnableValue, .true, .@"=");
            ...
            ref_out.flags.DAC1Enable = check_ref(?DAC1EnableList, DAC1EnableValue, .true, .@"=");
            ref_out.flags.DAC2Enable = check_ref(?DAC2EnableList, DAC2EnableValue, .true, .@"=");
            ...
            ref_out.flags.DFSDM2Enable = check_ref(?DFSDM2EnableList, DFSDM2EnableValue, .true, .@"=");
            ref_out.flags.SPI6OutputEnable = check_ref(?SPI6OutputEnableList, SPI6OutputEnableValue, .true, .@"=");
            ref_out.flags.EnableDFSDM2Audio = check_ref(?EnableDFSDM2AudioList, EnableDFSDM2AudioValue, .true, .@"=");
