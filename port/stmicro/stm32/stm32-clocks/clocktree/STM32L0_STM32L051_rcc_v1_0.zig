...
pub fn ClockTree(comptime mcu_data: std.StaticStringMap(void)) type {
    return struct {
        ...
        pub const Flag_Output = struct {
            ...
            LPTIMEnable: bool = false,
            LPUARTEnable: bool = false,
            ...
            @"48MEnable": bool = false,
            LSIUsed: bool = false,
            HSI48Used: bool = false,
            MSIUsed: bool = false,
        ...
        pub const Config_Output = struct {
            flags: Flag_Output = .{},
            HSI16_VALUE: ?f32 = null, //from RCC Clock Config
        ...
        pub fn get_clocks(config: Config) anyerror!Tree_Output {
            ...
            const PWR_Regulator_Voltage_ScaleValue: ?PWR_Regulator_Voltage_ScaleList = blk: {
                ...
                } else if ((((check_ref(?f32, AHBOutput.get_as_ref(), 4200000, .@">"))))) {
                    const conf_item = config.extra.PWR_Regulator_Voltage_Scale;
                    if (conf_item) |item| {
                        switch (item) {
                            .PWR_REGULATOR_VOLTAGE_SCALE2 => scale2 = true,
            ...
            //POST CLOCK REF 48USBFreq_Value VALUE
            _ = blk: {
                @"48USBOutput".limit = .{
                    .min = 4.788e7,
                    .max = 4.812e7,
            ...
            //POST CLOCK REF 48RNGFreq_Value VALUE
            _ = blk: {
                @"48RNGOutput".limit = .{
                    .min = null,
                    .max = 4.8e7,
            ...
            const FLatencyValue: ?FLatencyList = blk: {
                if ((((check_ref(?f32, AHBOutput.get_as_ref(), 0, .@">")) and ((check_ref(?f32, AHBOutput.get_as_ref(), 4200000, .@"<")) or ((check_ref(?f32, AHBOutput.get_as_ref(), 4200000, .@"="))))) and (scale3)) or (((check_ref(?f32, AHBOutput.get_as_ref(), 0, .@">")) and ((check_ref(?f32, AHBOutput.get_as_ref(), 8000000, .@"<")) or ((check_ref(?f32, AHBOutput.get_as_ref(), 8000000, .@"="))))) and (scale2)) or (((check_ref(?f32, AHBOutput.get_as_ref(), 0, .@">")) and ((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@"<")) or ((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@"="))))) and (scale1 or scale11))) {
                    ...
                    break :blk item;
                } else if ((((check_ref(?f32, AHBOutput.get_as_ref(), 8000000, .@">")) and ((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@"<")) or ((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@"="))))) and (scale2)) or (((check_ref(?f32, AHBOutput.get_as_ref(), 16000000, .@">")) and ((check_ref(?f32, AHBOutput.get_as_ref(), 32000000, .@"<")) or ((check_ref(?f32, AHBOutput.get_as_ref(), 32000000, .@"="))))) and (scale1 or scale11))) {
                    FLASH_LATENCY1 = true;
            ...
            ref_out.HSI16_VALUE = HSI16_VALUEValue;
            ...
            ref_out.flags.Semaphore_ETRpinUsedTIM22 = config.flags.Semaphore_ETRpinUsedTIM22;
            ref_out.flags.Semaphore_ETRpinUsedTIM21 = config.flags.Semaphore_ETRpinUsedTIM21;
            ...
            ref_out.flags.LPTIMEnable = check_ref(?LPTIMEnableList, LPTIMEnableValue, .true, .@"=");
            ref_out.flags.LPUARTEnable = check_ref(?LPUARTEnableList, LPUARTEnableValue, .true, .@"=");
            ...
            ref_out.flags.@"48MEnable" = check_ref(?@"48MEnableList", @"48MEnableValue", .true, .@"=");
            ref_out.flags.LSIUsed = check_ref(?f32, LSIUsedValue, 1, .@"=");
            ref_out.flags.HSI48Used = check_ref(?f32, HSI48UsedValue, 1, .@"=");
