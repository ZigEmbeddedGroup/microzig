...
pub fn configurePhaseCorrectDynamic(config: DynamicPwmConfig) void {
...
pub inline fn setTop(value: u16) void {
    regs.mem16(regs.ICR1).* = value;
}

pub inline fn setCompareA(value: u16) void {
    regs.mem16(regs.OCR1A).* = value;
}

pub inline fn setCompareB(value: u16) void {
    regs.mem16(regs.OCR1B).* = value;
}

pub inline fn setCounter(value: u16) void {
