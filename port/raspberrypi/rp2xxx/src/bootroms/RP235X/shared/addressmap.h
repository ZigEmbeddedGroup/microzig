...
#define REG_ALIAS_RW_BITS  (0x0u << 12u) // 0x000
#define REG_ALIAS_XOR_BITS (0x1u << 12u) //0x100
#define REG_ALIAS_SET_BITS (0x2u << 12u) //0x200
#define REG_ALIAS_CLR_BITS (0x3u << 12u) //0x300
