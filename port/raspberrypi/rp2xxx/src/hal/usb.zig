...
const DPRAM = switch (get_cpu()) {
    .RP2040 => peripherals.USBCTRL_DPRAM,
    .RP2350 => peripherals.USB_DPRAM,
};

const REGS = switch (get_cpu()) {
    .RP2040 => peripherals.USBCTRL_REGS,
    .RP2350 => peripherals.USB,
};
