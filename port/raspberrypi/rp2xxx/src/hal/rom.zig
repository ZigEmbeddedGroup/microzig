...
pub const Code = enum(u32) {
    popcount32 = rom_table_code('P', '3'),  // Only available on: RP2040
    reverse32 = rom_table_code('R', '3'),   // Only available on: RP2040
    clz32 = rom_table_code('L', '3'),       // Only available on: RP2040
    ctz32 = rom_table_code('T', '3'),       // Only available on: RP2040
    memset = rom_table_code('M', 'S'),      // Only available on: RP2040
    memset4 = rom_table_code('S', '4'),     // Only available on: RP2040
    memcpy = rom_table_code('M', 'C'),      // Only available on: RP2040
    memcpy44 = rom_table_code('C', '4'),    // Only available on: RP2040
